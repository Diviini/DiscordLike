...
// {
//     _options = new RestClientOptions("http://localhost:8080")
//     {
//         CookieContainer = new System.Net.CookieContainer() // 🎯 important ici
//     };
...
//         // Step 1 - Tester la connexion avec POST /auth/login
...
//             return (false, "Vos identifiants sont incorrects ❌", null);

//         if (!loginResponse.IsSuccessful)
//             return (false, $"Erreur serveur ({(int)loginResponse.StatusCode})", null);

//         // Step 2 - Appel GET /users/me pour récupérer les infos du user
